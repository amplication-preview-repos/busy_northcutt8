...
export class ProductControllerBase {
  ...
  async findAdvertisings(
    ...
    const query = plainToClass(AdvertisingFindManyArgs, request.query);
    const results = await this.service.findAdvertisings(params.id, {
      ...query,
      select: {
        budget: true,
        campaignName: true,
  ...
  @common.Post("/:id/advertisings")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  })
  async connectAdvertisings(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: AdvertisingWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      advertisings: {
        connect: body,
  ...
  @common.Patch("/:id/advertisings")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  })
  async updateAdvertisings(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: AdvertisingWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/advertisings")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  })
  async disconnectAdvertisings(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: AdvertisingWhereUniqueInput[]
  ): Promise<void> {
    const data = {
